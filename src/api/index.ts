...
import { cleanToken, fillEmptyBody, extractResData, injectToken, ReqConfig, toastError, navLogin } from './interceptors'
...
const errChain: ((_err: Error | AjaxResponse) => Promise<never>)[] = [cleanToken, navLogin, toastError]
